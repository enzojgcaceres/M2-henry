...
title.innerHTML = title.innerHTML + "HEnzo"
...
/*
input y crear el objeto
pushear el objeto a toDoItems = [{complete = false, description = "correr"}]
...
function addToDo() {
  ...
  var todo = new ToDo(toDoInput.value) // "caminar" 
  if(todo.description === ""){
